...
import com.example.nhom1_fe_datnhahang.ui.component.OrderCard
...
fun HistoryScreen(navController: NavController) {
    ...
    LaunchedEffect(Unit) {
        orderViewModel.fetchOrders(listOf("Đã giao hàng"))
    }
                    ...
                    OrderCard(
                        ...
                        onClicked = {
                            ...
                            navController.navigate(
                                "HistoryDetailScreen/${order.id}/${order.userId}/$encodedUserName/$encodedFmctoken/$encodedPhone/$encodedAddress/$encodedNote/$encodedStatus/$encodedItems/${order.totalPrice}/$encodedImageUrl"
                            )
                        }
                    )
                }
