...
fun OrderScreen(
    ...
    LaunchedEffect(Unit) {
        orderViewModel.fetchOrders(listOf("Đã đặt hàng", "Đã thanh toán"))
    }
                    ...
                    OrderCard(
                        ...
                        onClicked = {
                            ...
                            navController.navigate(
                                "OrderDetailScreen/${order.id}/${order.userId}/$encodedUserName/$encodedFmctoken/$encodedPhone/$encodedAddress/$encodedNote/$encodedStatus/$encodedItems/${order.totalPrice}"
                            )
                        }
                    )
                }
