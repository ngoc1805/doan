...
// ── Colors ────────────────────────────────────────────────────────────────────
val AdminPurple     = Color(0xFF6A1B9A)
val AdminPurpleDark = Color(0xFF4A148C)
val AdminPurpleLight= Color(0xFFCE93D8)
val AccentTeal      = Color(0xFF00897B)
val AccentGreen     = Color(0xFF43A047)
val SurfaceWhite    = Color(0xFFF8F5FF)
val CardWhite       = Color(0xFFFFFFFF)
val TextDark        = Color(0xFF1A1035)
...
val DividerColor    = Color(0xFFEDE7F6)
...
private val AdminColors = lightColors(
    primary         = AdminPurple,
    primaryVariant  = AdminPurpleDark,
...
fun AdminTheme(content: @Composable () -> Unit) {
    MaterialTheme(colors = AdminColors, typography = AdminTypography, content = content)
}